<?php
   ...
   $strQuery = "Select * From Area order by AreaCode; ";
                        ...
                        <tbody>
                          <?php  
                              for($i=0; $i < count($result); ++$i) {
                                ...
                                $edit_btn = "<button class='btn btn-warning' id=".$result[$i]['AreaCode']." onclick='Fill_Editing_Field(". $result[$i]['AreaCode'] .")' ><i class='bi bi-exclamation-triangle'></i>Edit</button> ";

                                $del_btn = "<button class='btn btn-danger' id=".$result[$i]['AreaCode']." onclick='confirm_delete(". $result[$i]['AreaCode'] .")' ><i class='bi bi-exclamation-octagon'></i>Delete</button>"; 

                                $PrimaryField = str_pad($result[$i]['AreaCode'], 4, '0', STR_PAD_LEFT);
               ...
               <div class="row">
                  ...
                  <div class="col-md-10">
                    <div class="form-group">
                      <label for="f1-last-name">Area Name</label>
                      <input type="text" id="txtName" name="txtName" placeholder="Area Name" class="f1-last-name form-control" required>
  ...
  <script type="text/javascript">
     $(document).ready(function(){
          ...
          $("#btnAdd").click(function(){
            ...
            $('.modal-title').text('Add New Area Info'); // Set Title to Bootstrap modal title  
          });
        ...
        $("#btnConfirmDelete").click(function(){
            ...
            $.post("Area_ed.php", {
                  ...
                  $('.modal-title').text('Delete Area Info'); // Set Title to Bootstrap modal title
        });
  ...
  function Fill_Editing_Field(id) {
    ...
    $.post("Area_ed.php", {
              id: id
                ...
                $('#Area_name').val(user[0].Area_name);
                $('#address').val(user[0].address);
            }
          );

          $('#modal-primary').modal('show');
          $('.modal-title').text('Edit Area Info'); // Set Title to Bootstrap modal title
  }
