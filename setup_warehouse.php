<?php
   ...
   $strQuery = "Select * From Warehouse order by WarehouseCode; ";
                        ...
                        <tbody>
                          <?php  
                              for($i=0; $i < count($result); ++$i) {
                                ...
                                $edit_btn = "<button class='btn btn-warning' id=".$result[$i]['WarehouseCode']." onclick='Fill_Editing_Field(". $result[$i]['WarehouseCode'] .")' ><i class='bi bi-exclamation-triangle'></i>Edit</button> ";

                                $del_btn = "<button class='btn btn-danger' id=".$result[$i]['WarehouseCode']." onclick='confirm_delete(". $result[$i]['WarehouseCode'] .")' ><i class='bi bi-exclamation-octagon'></i>Delete</button>"; 

                                $PrimaryField = str_pad($result[$i]['WarehouseCode'], 4, '0', STR_PAD_LEFT);
               ...
               <div class="row">
                  ...
                  <div class="col-md-10">
                    <div class="form-group">
                      <label for="f1-last-name">Warehouse Name</label>
                      <input type="text" id="txtName" name="txtName" placeholder="Warehouse Name" class="f1-last-name form-control" required>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  Warehouse Id: <label id="lblId"></label>
              </div>
  ...
  <script type="text/javascript">
     $(document).ready(function(){
          ...
          $("#btnAdd").click(function(){
            ...
            $('.modal-title').text('Add New Warehouse Info'); // Set Title to Bootstrap modal title  
          });
        ...
        $("#btnConfirmDelete").click(function(){
            ...
            $.post("Warehouse_ed.php", {
                  ...
                  $('.modal-title').text('Delete Warehouse Info'); // Set Title to Bootstrap modal title
        });
  ...
  function Fill_Editing_Field(id) {
    ...
    $.post("Warehouse_ed.php", {
              id: id
                ...
                $('#Warehouse_name').val(user[0].Warehouse_name);
                $('#address').val(user[0].address);
            }
          );

          $('#modal-primary').modal('show');
          $('.modal-title').text('Edit Warehouse Info'); // Set Title to Bootstrap modal title
  }
