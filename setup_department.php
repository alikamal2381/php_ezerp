<?php
   ...
   $strQuery = "Select * From Department order by DepartmentCode; ";
                        ...
                        <tbody>
                          <?php  
                              for($i=0; $i < count($result); ++$i) {
                                ...
                                $edit_btn = "<button class='btn btn-warning' id=".$result[$i]['DepartmentCode']." onclick='Fill_Editing_Field(". $result[$i]['DepartmentCode'] .")' ><i class='bi bi-exclamation-triangle'></i>Edit</button> ";

                                $del_btn = "<button class='btn btn-danger' id=".$result[$i]['DepartmentCode']." onclick='confirm_delete(". $result[$i]['DepartmentCode'] .")' ><i class='bi bi-exclamation-octagon'></i>Delete</button>"; 

                                $PrimaryField = str_pad($result[$i]['DepartmentCode'], 4, '0', STR_PAD_LEFT);
               ...
               <div class="row">
                  ...
                  <div class="col-md-10">
                    <div class="form-group">
                      <label for="f1-last-name">Department Name</label>
                      <input type="text" id="txtName" name="txtName" placeholder="Department Name" class="f1-last-name form-control" required>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  Department Id: <label id="lblId"></label>
              </div>
  ...
  <script type="text/javascript">
     $(document).ready(function(){
          ...
          $("#btnAdd").click(function(){
            ...
            $('.modal-title').text('Add New Department Info'); // Set Title to Bootstrap modal title  
          });
        ...
        $("#btnConfirmDelete").click(function(){
            ...
            $.post("Department_ed.php", {
                  ...
                  $('.modal-title').text('Delete Department Info'); // Set Title to Bootstrap modal title
        });
  ...
  function Fill_Editing_Field(id) {
    ...
    $.post("Department_ed.php", {
              id: id
                ...
                $('#Department_name').val(user[0].Department_name);
                $('#address').val(user[0].address);
            }
          );

          $('#modal-primary').modal('show');
          $('.modal-title').text('Edit Department Info'); // Set Title to Bootstrap modal title
  }
