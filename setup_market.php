                        ...
                        <tbody>
                          <?php  
                              for($i=0; $i < count($result); ++$i) {
                                ...
                                $edit_btn = "<button class='btn btn-warning' id=".$result[$i]['MarketCode']." onclick='Fill_Editing_Field(". $result[$i]['MarketCode'] .")' ><i class='bi bi-exclamation-triangle'></i>Edit</button> ";

                                $del_btn = "<button class='btn btn-danger' id=".$result[$i]['MarketCode']." onclick='confirm_delete(". $result[$i]['MarketCode'] .")' ><i class='bi bi-exclamation-octagon'></i>Delete</button>"; 

                                $PrimaryField = str_pad($result[$i]['MarketCode'], 4, '0', STR_PAD_LEFT);
