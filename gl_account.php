<?php
   $PageTitle = "Chart of Account Setup"; 
   ...
   $strQuery = "Select * From Chart_of_Account order by Chart of AccountCode; ";
                        ...
                        <tbody>
                          <?php  
                              for($i=0; $i < count($result); ++$i) {
                                ...
                                $edit_btn = "<button class='btn btn-warning' id=".$result[$i]['Chart of AccountCode']." onclick='Fill_Editing_Field(". $result[$i]['Chart of AccountCode'] .")' ><i class='bi bi-exclamation-triangle'></i>Edit</button> ";

                                $del_btn = "<button class='btn btn-danger' id=".$result[$i]['Chart of AccountCode']." onclick='confirm_delete(". $result[$i]['Chart of AccountCode'] .")' ><i class='bi bi-exclamation-octagon'></i>Delete</button>"; 

                                $PrimaryField = str_pad($result[$i]['Chart of AccountCode'], 4, '0', STR_PAD_LEFT);
               ...
               <div class="row">
                  ...
                  <div class="col-md-10">
                    <div class="form-group">
                      <label for="f1-last-name">Chart of Account Name</label>
                      <input type="text" id="txtName" name="txtName" placeholder="Chart of Account Name" class="f1-last-name form-control" required>
                      <div class="valid-feedback"></div>
                      <div class="invalid-feedback">Please enter Chart of Account Name.</div>
                    </div>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  Chart of Account Id: <label id="lblId"></label>
              </div>
  ...
  <script type="text/javascript">
     $(document).ready(function(){
          ...
          $("#btnAdd").click(function(){
            ...
            $('.modal-title').text('Add New Chart of Account Info'); // Set Title to Bootstrap modal title  
          });
        ...
        $("#btnConfirmDelete").click(function(){
            ...
            $.post("Chart of Account_ed.php", {
                  ...
                  $('.modal-title').text('Delete Chart of Account Info'); // Set Title to Bootstrap modal title
        });
        ...
        { 
            ...
            $.ajax({
              ...
              data: {
                        ...
                        Chart of Account_name: $("#Chart of Account_name").val(),
                        address: $("#address").val()
                    },
              cache: false,
  ...
  function Fill_Editing_Field(id) {
    ...
    $.post("Chart of Account_ed.php", {
              id: id
                ...
                $('#Chart of Account_name').val(user[0].Chart of Account_name);
                $('#address').val(user[0].address);
            }
          );

          $('#modal-primary').modal('show');
          $('.modal-title').text('Edit Chart of Account Info'); // Set Title to Bootstrap modal title
  }
