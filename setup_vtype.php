<?php
   ...
   $strQuery = "Select * From Voucher_Type order by Voucher TypeCode; ";
                        ...
                        <tbody>
                          <?php  
                              for($i=0; $i < count($result); ++$i) {
                                ...
                                $edit_btn = "<button class='btn btn-warning' id=".$result[$i]['Voucher TypeCode']." onclick='Fill_Editing_Field(". $result[$i]['Voucher TypeCode'] .")' ><i class='bi bi-exclamation-triangle'></i>Edit</button> ";

                                $del_btn = "<button class='btn btn-danger' id=".$result[$i]['Voucher TypeCode']." onclick='confirm_delete(". $result[$i]['Voucher TypeCode'] .")' ><i class='bi bi-exclamation-octagon'></i>Delete</button>"; 

                                $PrimaryField = str_pad($result[$i]['Voucher TypeCode'], 4, '0', STR_PAD_LEFT);
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Add New Voucher Type</h5>
               ...
               <div class="row">
                  ...
                  <div class="col-md-10">
                    <div class="form-group">
                      <label for="f1-last-name">Voucher Type Name</label>
                      <input type="text" id="txtName" name="txtName" placeholder="Voucher Type Name" class="f1-last-name form-control" required>
                      <div class="valid-feedback"></div>
                      <div class="invalid-feedback">Please enter Voucher Type Name.</div>
                    </div>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  Voucher Type Id: <label id="lblId"></label>
              </div>
  ...
  <script type="text/javascript">
     $(document).ready(function(){
          ...
          $("#btnAdd").click(function(){
            ...
            $('.modal-title').text('Add New Voucher Type Info'); // Set Title to Bootstrap modal title  
          });
        ...
        $("#btnConfirmDelete").click(function(){
            ...
            $.post("Voucher Type_ed.php", {
                  ...
                  $('.modal-title').text('Delete Voucher Type Info'); // Set Title to Bootstrap modal title
        });
        ...
        { 
            ...
            $.ajax({
              ...
              data: {
                        ...
                        Voucher Type_name: $("#Voucher Type_name").val(),
                        address: $("#address").val()
                    },
              cache: false,
  ...
  function Fill_Editing_Field(id) {
    ...
    $.post("Voucher Type_ed.php", {
              id: id
                ...
                $('#Voucher Type_name').val(user[0].Voucher Type_name);
                $('#address').val(user[0].address);
            }
          );

          $('#modal-primary').modal('show');
          $('.modal-title').text('Edit Voucher Type Info'); // Set Title to Bootstrap modal title
  }
