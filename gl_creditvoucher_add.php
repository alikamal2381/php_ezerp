<?php
   $PageTitle = "Add New Credit Voucher"; 
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-body wizard-content">
              <h4 class="card-title">Credit Voucher</h4>
              <h6 class="card-subtitle">BR/CR (Receipt Voucher)</h6>
                ...
                <div class="panel-body">
                  <div class="row">
                      ...
                      <div class="col-sm-12">
                          ...
                          <input type="button" class="btn btn-danger float-end" data-bs-dismiss="modal" value="Back to Home" onClick="document.location.href='gl_Creditvoucher.php'" />
                      </div>
                  </div>
                  <hr />
